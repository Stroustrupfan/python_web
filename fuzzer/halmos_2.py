from halmos import SymbolicVM, SolidityFrontend
...
frontend = SolidityFrontend(soldity_code)

contract = frontend.get_contract("0x75780415fCA0157e4814A1A2588f1eE9Ff0F7E88")